        ...
        <div className="bg-gray-900 rounded-lg shadow-lg overflow-hidden">
            <table className="min-w-full">
                <thead className="bg-gray-700">
                    <tr>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase">Número do Processo</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase">Credor</th>
                    ...
                    {processos.length > 0 ? processos.map(proc => (
                        <tr key={proc.id} className="hover:bg-gray-800">
                            <td className="px-6 py-4">
                                <Link to={`/processos/${proc.id}`} className="text-purple-400 hover:underline font-mono">
                                    {proc.numero}
                                </Link>
                            </td>
                            <td className="px-6 py-4">{proc.credor}</td>
                            <td className="px-6 py-4">
